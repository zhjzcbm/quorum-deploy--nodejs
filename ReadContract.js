...
if (argv.length==4){
	let call = async () => {
			...
			//解锁账户
		await web3.eth.personal.unlockAccount(account[0],'');
			contractInstance.methods.Show(argv[3]/*如果需要有参数的话*/).call({
			from: account[0],
			}).then((result) => {
					console.log(result)
		})
...
if (argv.length==5){
	let call = async () => {
			...
			//解锁账户
		await web3.eth.personal.unlockAccount(account[0],'');
			contractInstance.methods.Show(argv[4]/*如果需要有参数的话*/).call({
			from: account[0],
			}).then((result) => {
					console.log(result)
		})
...
if (argv.length==6){
	let call = async () => {
			...
			//解锁账户
		await web3.eth.personal.unlockAccount(account[0],'');
			contractInstance.methods.Show(argv[5]/*如果需要有参数的话*/).call({
			from: account[0],
			}).then((result) => {
					console.log(result)
		})
...
if (argv.length==7){
	let call = async () => {
			...
			//解锁账户
		await web3.eth.personal.unlockAccount(account[0],'');
			contractInstance.methods.Show(argv[6]/*如果需要有参数的话*/).call({
			from: account[0],
			}).then((result) => {
					console.log(result)
		})
...
if (argv.length==8){
	let call = async () => {
			...
			//解锁账户
		await web3.eth.personal.unlockAccount(account[0],'');
			contractInstance.methods.Show(argv[7]/*如果需要有参数的话*/).call({
			from: account[0],
			}).then((result) => {
					console.log(result)
		})
...
if (argv.length==9){
	let call = async () => {
			...
			//解锁账户
		await web3.eth.personal.unlockAccount(account[0],'');
			contractInstance.methods.Show(argv[8]/*如果需要有参数的话*/).call({
			from: account[0],
			}).then((result) => {
					console.log(result)
		})
...
if (argv.length==10){
	let call = async () => {
			...
			//解锁账户
		await web3.eth.personal.unlockAccount(account[0],'');
			contractInstance.methods.Show(argv[9]/*如果需要有参数的话*/).call({
			from: account[0],
			}).then((result) => {
					console.log(result)
		})
